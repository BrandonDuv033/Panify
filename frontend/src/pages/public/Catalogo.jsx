...
const Catalogo = () => {
  // Lista de productos simulados de panadería
  const [productos] = useState([
    { id: 1, nombre: 'Pan Francés', categoria: 'Pan', precio: 1500, imagen: '🍞' },
    { id: 2, nombre: 'Croissant', categoria: 'Pastelería', precio: 3000, imagen: '🥐' },
    { id: 3, nombre: 'Roscon', categoria: 'Pan', precio: 1500, imagen: '🍞' },
    { id: 4, nombre: 'Dona', categoria: 'Pastelería', precio: 2500, imagen: '🍩' },
  ]);
  ...
  return (
    <div>
      ...
      <main className="productos container py-5" style={{ marginTop: '80px' }}>
        ...
        <div className="row">
          {/* Productos Grid con el botón de agregar visible */}
            ...
            {productosFiltrados.map((prod) => (
              <div className="col-md-6" key={prod.id}>
                <div className="tarjeta h-100 d-flex flex-column justify-content-between p-3">
                  <div>
                    <div className="text-center pt-2 fs-1">{prod.imagen}</div>
                    <div className="card-body px-0">
                      <h3 className="text-white">{prod.nombre}</h3>
                      <p className="text-light opacity-75 mb-2">{prod.categoria}</p>
            ...
            <div className="p-4 tarjeta shadow bg-white rounded text-dark">
              ...
              <div className="tarjeta-body p-0" style={{ minHeight: '150px' }}>
                {carrito.length === 0 ? (
                  ...
                  carrito.map((item) => (
                    <div key={item.id} className="d-flex justify-content-between align-items-center mb-2 border-bottom pb-2">
                      <div>
